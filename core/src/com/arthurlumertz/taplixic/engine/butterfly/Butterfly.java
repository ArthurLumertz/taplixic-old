package com.arthurlumertz.taplixic.engine.butterfly;
...
public class Butterfly extends Entity {
	...
	public Butterfly(RayHandler rayHandler) {
	...
	public void show() {
		...
		int res = (int) Math.round(Math.random()); // 0 or 1
